        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="fw-light" align="center">Sign in to continue.</h6>
              <form class="pt-3" action="server.php" method="post">
                ...
                <div class="mt-3" align="center">
					<input align="middle" type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="Sign In" name="login_user">
