					...
					<div class="white_card_body">
						...
						<form>
							...
							<div class="mb-3">
								...
								<label class="form-label" for="category name">Brand Name</label>
							...
							<div class="input-group mb-3">
								...
								<label class="input-group-text" for="category image">Brand Image</label>

							</div>
							
							<button type="submit" class="btn btn-primary" name="add-product">Add Brand</button>
