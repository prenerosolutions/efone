								...
								<table class="table lms_table_active ">
									...
									<tbody>
										...
										<tr>
											...
											<td><img src="../img/sub-categories/<?php echo $crow['sub_ctg_img']; ?>" alt="<?php echo $crow['sub_ctg_img']; ?>" style="width: 100px; border-radius: 15px;"></td>

											<td><?php echo $crow['sub_ctg_name']; ?>
											
											</td>
											
											<td><?php echo $crow['category_id']; ?>
