							...
							<div class="QA_table mb_30">
								...
								<table class="table lms_table_active ">
									...
									<tbody>
										...
										$query=mysqli_query($connect,"SELECT * FROM `orders` WHERE `order_status`='completed'");
										...
										<tr>
											...
											<td><img src="../img/customers/<?php echo $crow['customer_pic']; ?>" alt="<?php echo $crow['customer_pic']; ?>" style="height: 100px; border-radius: 15px;"></td>

											<td><?php echo $crow['first_name']; ?> <?php echo $crow['last_name']; ?>
											
											</td>
											
											<td><?php echo $orow['order_total']; ?>
											 
											</td>
											<td><?php echo $orow['order_status']; ?>
