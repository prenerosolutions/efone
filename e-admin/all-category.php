								...
								<table class="table lms_table_active ">
									...
									<tbody>
										...
										<tr>
											...
											<td><img src="../img/categories/<?php echo $crow['category_image']; ?>" alt="<?php echo $crow['category_image']; ?>" style="width: 100px; border-radius: 15px;"></td>

											<td><?php echo $crow['category_name']; ?>
